                  ...
                  TextButton(
                    onPressed: () async {
                      var route = new MaterialPageRoute(
                        builder : (BuildContext context) => new CondoBodyPage(),
                      );
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Flexible(
                                child: IconButton(
                                  onPressed: (){
                                    Navigator.pushNamed(context, AppRoute.CondoManagementPageRoute, arguments: condo);
                                  },
