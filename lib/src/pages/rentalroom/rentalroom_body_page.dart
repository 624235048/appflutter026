...
class RentalroomBodyPage extends StatefulWidget {
  @override
  _RentalroomBodyPageState createState() => _RentalroomBodyPageState();

}

class _RentalroomBodyPageState extends State<RentalroomBodyPage> {
                  ...
                  TextButton(
                    onPressed: () async {
                      var route = new MaterialPageRoute(
                        builder : (BuildContext context) => new RentalroomBodyPage(),
                      );
                    ...
                    child: ListTile(
                      ...
                      title: Column(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Flexible(
                                child: IconButton(
                                  onPressed: (){
                                    Navigator.pushNamed(context, AppRoute.RentalManagementPageRoute, arguments: dormitory);
                                  },
                          ...
                          // condo.condoPhone == '0'
                          //     ? Text('฿' + condo.condoPrice + '   out of stock')
                          //     : Text('฿' +
                          //     condo.condoPrice +
                          //     " " 'stock :' +
                          //     condo.condoPhone),
                          ...
                          //       child: IconButton(
                          //         onPressed: () {
                          //           // Navigator.pushNamed(context, AppRoute.gameManament, arguments: game);
                          //         },
